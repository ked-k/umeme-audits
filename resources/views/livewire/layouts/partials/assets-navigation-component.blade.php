<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        <li>
            ...
            <ul>
                <li> <a href="{{ route('assets-dashboard') }}"><i
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">{{ __('Assets and Equipments') }}</div>
            </a>
            <ul>
                <li> <a href="{{ route('manage-assets') }}"><i
                            class="bx bx-right-arrow-alt"></i>{{ __('Manage Assets') }}</a>
                </li>
            </ul>
        </li>
