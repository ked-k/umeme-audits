                        ...
                        <div class="tab-content">
                            <div class="table-responsive">
                                <table id="datableButton" class="table table-borderedtable-bordered table-striped mb-0 w-100 sortable">
                                    ...
                                    <tbody>
                                        @foreach ($zones as $key => $type)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $type->name }}</td>
                                                <td>{{ $type->district->name??'N/A' }}</td>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="btn-group float-end">
                                        {{ $zones->links('vendor.livewire.bootstrap') }}
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end tab-content-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('New Zone') }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                              ...
                              <select name="district_id" class="form-control form-control" wire:model.differ='district_id' id="district_id">
